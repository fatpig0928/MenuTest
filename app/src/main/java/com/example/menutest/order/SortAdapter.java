...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            viewHolder.tvTranslation = (TextView) view.findViewById(R.id.translation);
        ...
        viewHolder.tvTitle.setText(this.list.get(position).getQuery());
        viewHolder.tvTranslation.setText(this.list.get(position).getTranslation());
