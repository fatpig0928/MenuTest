...
public class SpringProgressView extends View {
    ...
    /**分段颜色*/
    private static final int[] SECTION_COLORS = {R.color.titleNormalColor,R.color.titleNormalColor,R.color.titleNormalColor};
    /**进度条最大值*/
    ...
    private int progressBackColor=getResources().getColor(R.color.corner_bg);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.rgb(103, 120, 86));  //边框的颜色
